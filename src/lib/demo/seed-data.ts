...
function makeUser(
  ...
  return {
    ...partial,
    school_region: partial.school_region ?? "无锡学院",
    six_dim_score: six,
    level: calcLevel(six),
    created_at: created,
    updated_at: created,
...
export const DEMO_USERS: CampusUser[] = [
  ...
  makeUser({
    ...
    last_active_at: format(subDays(new Date(), 1), "yyyy-MM-dd") + "T10:00:00.000Z",
  }),
  makeUser({
    id: "u9",
    name: "流失样",
...
export const DEMO_STAGE_LOGS: UserStageLog[] = [
  {
    ...
    status: "done",
    note: "职规沟通录音",
    record_url: "demo://recordings/demo-t0-cs1/u1/career.m4a",
    owner_id: "demo-t0-cs1",
  ...
  },
  {
    ...
    status: "done",
    note: "关单沟通",
    record_url: "demo://recordings/demo-t0-se1/u3/close.m4a",
    owner_id: "demo-t0-se1",
